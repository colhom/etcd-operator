...
const (
	...
	PeerCACertName   = "peer-ca-crt.pem"
	ClientCAKeyName  = "client-ca-key.pem"
	ClientCACertName = "client-ca-crt.pem"

	NodeClientKeyName  = "client-key.pem"
	NodeClientCertName = "client-crt.pem"
	NodePeerKeyName    = "peer-key.pem"
	NodePeerCertName   = "peer-crt.pem"

	EtcdClientKeyName  = "etcd-client-key.pem"
	EtcdClientCertName = "etcd-client-crt.pem"
)
...
func NewPeerServerSecret(secretName string, peerKey *rsa.PrivateKey, peerCert, peerCACert *x509.Certificate) (*v1.Secret, error) {
	...
	tlsSecret := v1.Secret{
		...
		Data: map[string][]byte{
			...
			PeerCACertName:   tlsutil.EncodeCertificatePEM(peerCACert),
		},
	}
...
func NewClientServerSecret(secretName string, clientKey *rsa.PrivateKey, clientCert, clientCACert *x509.Certificate) (*v1.Secret, error) {
	...
	tlsSecret := v1.Secret{
		...
		Data: map[string][]byte{
			...
			ClientCACertName:   tlsutil.EncodeCertificatePEM(clientCACert),
		},
	}
